...
function findAdults(persons) {
    const maleArray = persons.filter((person => person.age >= 18) && (person => person.sex === 'male'));
    const femaleArray = persons.filter((person => person.age >= 18) && (person => person.sex === 'female'));
